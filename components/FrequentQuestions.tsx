            ...
            <div className="container flex flex-col">
                ...
                <div className="flex flex-col lg:flex-row items-center gap-6">
                    ...
                    <Accordion type="single" collapsible className="w-full flex flex-col gap-2">
                        <AccordionItem value="item-1" className="border-gray-300 dark:border-gray-700 rounded-md px-4 no-underline shadow-md bg-white dark:bg-[var(--blue-secondary)]">
                            <AccordionTrigger className="hover:no-underline">Is it accessible?</AccordionTrigger>
                            <AccordionContent>
                                Yes. It adheres to the WAI-ARIA design pattern.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-2" className="border-gray-300 dark:border-gray-700 rounded-md px-4 no-underline shadow-md bg-white dark:bg-[var(--blue-secondary)]">
                            <AccordionTrigger className="hover:no-underline">Is it accessible?</AccordionTrigger>
                            <AccordionContent>
                                Yes. It adheres to the WAI-ARIA design pattern.
                            </AccordionContent>
                        </AccordionItem>
                        <AccordionItem value="item-3" className="border-gray-300 dark:border-gray-700 rounded-md px-4 no-underline shadow-md bg-white dark:bg-[var(--blue-secondary)]">
                            <AccordionTrigger className="hover:no-underline">Is it accessible?</AccordionTrigger>
                            <AccordionContent>
                                Yes. It adheres to the WAI-ARIA design pattern.
                            </AccordionContent>
